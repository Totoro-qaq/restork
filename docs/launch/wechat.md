...
有没有未读邮件、最近收藏了什么项目，或者今天可以听哪一首歌。

它还很年轻，现在是 MIT 开源的 macOS Alpha。很多地方仍在认真打磨，但我已经开始把它当作自己
...
Alpha 已能本地构建，Windows/Linux 和正式签名发布还在继续验收。
